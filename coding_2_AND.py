# Coding Question_2
# Implementation of perceptron that can learn the boolean
# function AND using threshold activation function (Can use sigmoid or tanh in our implemenetation). 

import numpy as np


# Function definition to perform sigmoid.
...
def print_data(iter, inputs, keys, weights, prediction):
	...
	print "The original input data was... \n", inputs
